...
user would otherwise have to remember. A number the user must hold in their
...
| [The turn budget](/design/turn-budget/) | How long a unit may be, and what the user does when it is longer. |
...
| [Tool design for voice](/design/tool-design/) | Tools whose latency the user can hear. |
