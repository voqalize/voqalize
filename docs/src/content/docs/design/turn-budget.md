...
description: Between the user finishing a sentence and hearing a syllable, exactly one interval belongs to your code. Where it goes, how to measure it, and why a fast turn is one that starts fast.
---
