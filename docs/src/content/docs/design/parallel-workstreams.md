...
- [The turn budget](/docs/design/the-turn-budget/) — where the time in a single turn goes.
- [Voice points, the screen holds](/docs/design/voice-points-screen-holds/) — why the screen is the wide channel.
