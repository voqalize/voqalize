...
- [The turn budget](/docs/design/the-turn-budget/) — the one interval of a turn your code controls.
- [Interruption and heard truth](/docs/design/interruption-and-heard-truth/) — what the caller heard, which is what a transcript records.
