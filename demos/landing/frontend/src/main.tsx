 ...
 * shared manifest (`demos/manifest.json`). Each card links to `/demos/{name}`,
 * the demo's own MPA entrypoint. Keeping this manifest-driven means adding a demo
...
// ^ the shared demos directory (demos/manifest.json) — the one file that lists
// every demo's card. This landing app is its only reader.
