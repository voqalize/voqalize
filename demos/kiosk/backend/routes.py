"""Vantage Bank branch kiosk — the demo's own FastAPI brain route.

Voqalize dials ``/kiosk?session_id=…`` once per session (the inbound path); the
