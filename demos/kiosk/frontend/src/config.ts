 ...
 * uninterpreted by everything between here and there. This kiosk sends one fact
 * in it, the surface it is running on, because a totem in a private cubicle and
 * a phone are not the same conversation.
 *
 ...
 * can move the STT and TTS legs together. Rohan speaks English and Hindi and
