 ...
 * who is calling and, for a walk-in with no state on file yet, has to guess
 * from the enquiry form's own state field. Naming it here as well would be two
 * owners of one answer, which is the failure mode this whole mechanism exists
 * to rule out.
 *
