...
# A quiet acknowledgement, not a chat-assistant greeting. Generic (no counterparty
# name) to sidestep any future TTS mispronunciation of a specific vendor name.
