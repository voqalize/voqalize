"""Docket — Contract Review — the demo's own FastAPI brain route.

Voqalize dials `/legal?session_id=…` once per session (the inbound path); the
